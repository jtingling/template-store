                ...
                <Row className="d-flex flex-column flex-sm-row">
                    ...
                    <Col>
                        ...
                        <Row xs={2} className='mt-3'>
                            ...
                            <Col className='m-1'><span className="display-7"><strong>Shipping calculated at checkout</strong></span></Col>
                            <Col className='m-1'><p className="display-5">Size</p></Col>
                        </Row>
                        ...
                        <Row sm={1} className="d-flex flex-column flex-sm-row w-xs-5 w-75 mx-auto">
                            <Button variant='light' className="my-3 py-3 px-0 mx-0"
                                onClick={async () => {
                                    ...
                                    try {
                                        clientCheckout = await addItemToCart(cartId, item);
                                    } catch (e) {
                                        setIsError(true)
                                    }
                                    if (clientCheckout !== 0) {
